With this project my aim is to answer the following question using advanced SQL.
/*
1. TOP SELLING PRODUCT:
    Query the top 10 products by the total sales value.
...
*/
/*
7. Customer Lifetime Value (CLTY)
...
*/
/*
16. IDENTETY customers into returning or new
